...
import com.jcedar.chartbills.activity.AddNewBillActivity;
import com.jcedar.chartbills.activity.NewBillActivity;
import com.jcedar.chartbills.activity.SettingsActivity;
...
/**
 * Created by OLUWAPHEMMY on 3/26/2017.
 */
...
public class NewBillFragment extends Fragment {
    ...
    private void popUp() {
        View v  = view.findViewById(R.id.action_date_filter);
...
//                        String time4 = "last_month";
                        ...
                        sectionAdapter.addSection(new NewBillFragment.BillSection(NewBillFragment.BillSection.UPCOMING, time));
                        sectionAdapter.addSection(new NewBillFragment.BillSection(NewBillFragment.BillSection.OVERDUE, time));
                        sectionAdapter.addSection(new NewBillFragment.BillSection(NewBillFragment.BillSection.PAID, time));
...
/*        toolbar.setTitle("This Month");
        toolbar.setTitleTextColor(ContextCompat.getColor(getActivity(), R.color.my_gray));
        getActivity().setActionBar(toolbar);*/
        setHasOptionsMenu(true);

        MobileAds.initialize(getActivity().getApplicationContext(), "ca-app-pub-7164033483674077~1201302248");

        RelativeLayout comBannerAd = (RelativeLayout) view.findViewById(R.id.banner_AdView);
...
//        String timee  = "this_month";
        ...
        sectionAdapter.addSection(UPCOMING_TAG, new NewBillFragment.BillSection(NewBillFragment.BillSection.UPCOMING, time));
        sectionAdapter.addSection(OVERDUE_TAG, new NewBillFragment.BillSection(NewBillFragment.BillSection.OVERDUE, time));
        sectionAdapter.addSection(PAID_TAG, new NewBillFragment.BillSection(NewBillFragment.BillSection.PAID, time));


        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerviewNewBill);
...
//        recyclerView.notifyAll();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent addNewIntent = new Intent(getActivity(), AddNewBillActivity.class);
...
//        final static int SPORTS = 3;
        ...
        String defCurrency = pref.getString(getActivity().getResources().getString(R.string.pref_key_currency),
                getActivity().getResources().getString(R.string.pref_currency_default));
...
//                Calendar wsCal = Calendar.getInstance();
            ...
            CursorLoader cursorLoader = new CursorLoader(getActivity(), ChartBillContract.Bills.CONTENT_URI,
...
//                Calendar wsCal = Calendar.getInstance();
        ...
        public RecyclerView.ViewHolder getItemViewHolder(View view) {
            return new NewBillFragment.ItemViewHolder(view);
        }

        @Override
        public void onBindItemViewHolder(RecyclerView.ViewHolder holder, final int position) {

            NewBillFragment.ItemViewHolder itemHolder = (NewBillFragment.ItemViewHolder) holder;
            ...
            if ("upcoming".equalsIgnoreCase(status)){
                ...
                itemHolder.tvDate.setTextColor(ContextCompat.getColor(getActivity(),R.color.colorAccent));
            } else if ("overdue".equalsIgnoreCase(status)){
                String formattedDate = FormatUtils.getReadableDate(Long.parseLong(list.get(position).getDueDate()));
                itemHolder.tvDate.setText(formattedDate);
                itemHolder.tvDate.setTextColor(ContextCompat.getColor(getActivity(),R.color.red_button_color));
        ...
        private void changeBillStatus(String status, String symbi, String dueDat, List<Bill> mlist) {
            switch (status) {
                case "upcoming":
                    ...
                    getActivity().getContentResolver().update(ChartBillContract.Bills.CONTENT_URI, mValue, ChartBillContract.Bills._ID + "=?",
                            new String[]{symbi});
...
//                    sectionAdapter.notifyDataSetChanged();
                ...
                case "overdue":
                    ...
                    getActivity().getContentResolver().update(ChartBillContract.Bills.CONTENT_URI, oValue, ChartBillContract.Bills._ID + "=?",
                            new String[]{symbi});
...
//                    String symbi = c.getString(c.getColumnIndex(ChartBillContract.Bills._ID));
                    ...
                    getActivity().getContentResolver().update(ChartBillContract.Bills.CONTENT_URI, pValue, ChartBillContract.Bills._ID + "=?",
                            new String[]{symbi});
        ...
        public RecyclerView.ViewHolder getHeaderViewHolder(View view) {
            return new NewBillFragment.HeaderViewHolder(view);
        }
        ...
        public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder) {
            ...
            String data = "TRUE";
            NewBillFragment.HeaderViewHolder headerHolder = (NewBillFragment.HeaderViewHolder) holder;
            if ((list.size() <= 0) && (title.equalsIgnoreCase("upcoming"))) {
//                headerHolder.root.setVisibility(View.INVISIBLE);
//                notifyActivity(data);
//                sectionAdapter.getSection(UPCOMING_TAG).setVisible(false);
...
//                sectionAdapter.removeSection(PAID_TAG);
            ...
            if (title.equalsIgnoreCase("paid")) {
                headerHolder.tvTitle.setTextColor(ContextCompat.getColor(getActivity(), R.color.green_button_color));
                headerHolder.tvTitleCount.setTextColor(ContextCompat.getColor(getActivity(), R.color.green_button_color));
                headerHolder.tvTitlePrice.setTextColor(ContextCompat.getColor(getActivity(), R.color.green_button_color));
            }
            if (title.equalsIgnoreCase("overdue")) {
                headerHolder.tvTitle.setTextColor(ContextCompat.getColor(getActivity(), R.color.red_button_color));
                headerHolder.tvTitleCount.setTextColor(ContextCompat.getColor(getActivity(), R.color.red_button_color));
                headerHolder.tvTitlePrice.setTextColor(ContextCompat.getColor(getActivity(), R.color.red_button_color));
            }
